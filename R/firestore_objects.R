...
#' A map value.
#' 
#' @param MapValue.fields The \link{MapValue.fields} object or list of objects
#' @param fields The map's fields
#' 
#' @return MapValue object
#' 
#' @family MapValue functions
#' @export
MapValue <- function(MapValue.fields = NULL, fields = NULL) {
    structure(list(MapValue.fields = MapValue.fields, fields = fields), class = c("gar_MapValue",
        "list"))
}
...
#' 
#' @param WriteRequest.labels The \link{WriteRequest.labels} object or list of objects
...
#' @export
WriteRequest <- function(WriteRequest.labels = NULL, writes = NULL, streamToken = NULL,
    labels = NULL, streamId = NULL) {
    structure(list(WriteRequest.labels = WriteRequest.labels, writes = writes, streamToken = streamToken,
        labels = labels, streamId = streamId), class = c("gar_WriteRequest", "list"))
}

#' WriteRequest.labels Object
#' 
#' @details 
#' Autogenerated via \code{\link[googleAuthR]{gar_create_api_objects}}
...
#' 
#' 
#' @return WriteRequest.labels object
#' 
#' @family WriteRequest functions
#' @export
WriteRequest.labels <- function() {
    list()
}
...
#' 
#' @param Document.fields The \link{Document.fields} object or list of objects
...
#' @export
Document <- function(Document.fields = NULL, updateTime = NULL, fields = NULL, name = NULL,
    createTime = NULL) {
    structure(list(Document.fields = Document.fields, updateTime = updateTime, fields = fields,
        name = name, createTime = createTime), class = c("gar_Document", "list"))
}
...
#' 
#' @param ListenRequest.labels The \link{ListenRequest.labels} object or list of objects
...
#' @export
ListenRequest <- function(ListenRequest.labels = NULL, labels = NULL, removeTarget = NULL,
    addTarget = NULL) {
    structure(list(ListenRequest.labels = ListenRequest.labels, labels = labels,
        removeTarget = removeTarget, addTarget = addTarget), class = c("gar_ListenRequest",
        "list"))
}

#' ListenRequest.labels Object
#' 
#' @details 
#' Autogenerated via \code{\link[googleAuthR]{gar_create_api_objects}}
...
#' 
#' 
#' @return ListenRequest.labels object
#' 
#' @family ListenRequest functions
#' @export
ListenRequest.labels <- function() {
    list()
}
...
#' @export
StructuredQuery <- function(offset = NULL, where = NULL, startAt = NULL, endAt = NULL,
    limit = NULL, from = NULL, orderBy = NULL, select = NULL) {
    structure(list(offset = offset, where = where, startAt = startAt, endAt = endAt,
        limit = limit, from = from, orderBy = orderBy, select = select), class = c("gar_StructuredQuery",
        "list"))
}
...
Location <- function(Location.labels = NULL, Location.metadata = NULL, labels = NULL,
    ...
    structure(list(Location.labels = Location.labels, Location.metadata = Location.metadata,
        labels = labels, metadata = metadata, locationId = locationId, name = name,
...
#' 
#' @param BatchWriteRequest.labels The \link{BatchWriteRequest.labels} object or list of objects
...
#' @export
BatchWriteRequest <- function(BatchWriteRequest.labels = NULL, labels = NULL, writes = NULL) {
    structure(list(BatchWriteRequest.labels = BatchWriteRequest.labels, labels = labels,
        writes = writes), class = c("gar_BatchWriteRequest", "list"))
}

#' BatchWriteRequest.labels Object
#' 
#' @details 
#' Autogenerated via \code{\link[googleAuthR]{gar_create_api_objects}}
...
#' 
#' 
#' @return BatchWriteRequest.labels object
#' 
#' @family BatchWriteRequest functions
#' @export
BatchWriteRequest.labels <- function() {
    list()
}
...
#' @export
GoogleLongrunningOperation <- function(GoogleLongrunningOperation.metadata = NULL,
    GoogleLongrunningOperation.response = NULL, metadata = NULL, response = NULL,
    done = NULL, error = NULL, name = NULL) {
    structure(list(GoogleLongrunningOperation.metadata = GoogleLongrunningOperation.metadata,
        GoogleLongrunningOperation.response = GoogleLongrunningOperation.response,
